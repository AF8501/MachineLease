...
public class IndexScroller
{
	...
	private int indexPaintColor = R.color.equipmentlist_indexScroller_text_normal; // color for section title

	private int indexCurrentPaintColor = R.color.equipmentlist_indexScroller_text_current;
	...
	public void drawIndexBarContainer(Canvas canvas)
	{
		...
		indexbarContainerPaint.setAlpha((int) (64 * mAlphaRate)); // opaEquipment
		canvas.drawRoundRect(mIndexbarRect, 5 * mDensity, 5 * mDensity,
				indexbarContainerPaint);
	}

	public void drawSections(Canvas canvas,int letterNum)
	{
		...
		for (int i = 0; i < mSections.length; i++)
		{
			//加亮显示当前首字母。
			if(i==letterNum){
				indexPaint.setColor(context.getResources().getColor(indexCurrentPaintColor));
			}else {
				indexPaint.setColor(context.getResources().getColor(indexPaintColor));
			}
	...
	public void draw(Canvas canvas,int letterNum)
	{
	...
	public int getIndexCurrentPaintColor() {
		return indexCurrentPaintColor;
	}

	public void setIndexCurrentPaintColor(int indexCurrentPaintColor) {
		this.indexCurrentPaintColor = indexCurrentPaintColor;
	}
