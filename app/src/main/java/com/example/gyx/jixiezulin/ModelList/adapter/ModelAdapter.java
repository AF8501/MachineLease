package com.example.gyx.jixiezulin.ModelList.adapter;
...
public class ModelAdapter extends ContactListAdapter
{
	private int selectionPosition;
	private int resource;
	private Context context;
	public ModelAdapter(Context _context, int _resource,
